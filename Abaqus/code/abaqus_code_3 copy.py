...
def _cae(paras, index, dic_path, odb_path):
    ...
    s.Line(point1=(0.0, 0.0), point2=(0.0, 10.0))
    s.VerticalConstraint(entity=g[3], addUndoState=False)
    s.Line(point1=(0.0, 0.0), point2=(15.0, 0.0))
    ...
    s.Line(point1=(d1x, 0.0), point2=(d2x, d2y))
    
    s.radialPattern(geomList=(g[7], ), vertexList=(), number=2, totalAngle=360.0, 
        centerPoint=(length_x, length_y))
    s.copyMirror(mirrorLine=g[3], objectList=(g[2], g[5], g[6], g[7], g[8]))
    s.copyMirror(mirrorLine=g[4], objectList=(g[2], g[3], g[5], g[6], g[7], g[8], 
    ...
    p = mdb.models['Model-1'].Part(name='chiral', dimensionality=TWO_D_PLANAR, 
        type=DEFORMABLE_BODY)
    p = mdb.models['Model-1'].parts['chiral']
    p.BaseWire(sketch=s)
    ...
    p = mdb.models['Model-1'].parts['chiral']
    e = p.edges
    edges = e.getSequenceFromMask(mask=('[#ffffffff:22 ]', ), )
    ...
    p = mdb.models['Model-1'].parts['chiral']
    a.Instance(name='chiral-1', part=p, dependent=ON)
    session.viewports['Viewport: 1'].assemblyDisplay.setValues(
        adaptiveMeshConstraints=ON)
    
    ################ Step  ########## 
    mdb.models['Model-1'].StaticStep(name='Step-1', previous='Initial', 
        maxNumInc=1000, initialInc=0.005, minInc=1e-06, maxInc=0.1)
    ...
    a = mdb.models['Model-1'].rootAssembly
    v1 = a.instances['chiral-1'].vertices
    verts1 = v1.getSequenceFromMask(mask=(
        '[#80000000 #0 #200000 #0 #4000 #0 #1000000', 
        ' #0:2 #20 #40000000 #0 #800000 #0 #2000 ]', ), )
    ...
    a = mdb.models['Model-1'].rootAssembly
    v1 = a.instances['chiral-1'].vertices
    verts1 = v1.getSequenceFromMask(mask=('[#2000 #0 #8 #10000000 #0:3 #8 #800', 
        ' #0 #10 #20000000 #0 #80000 ]', ), )
